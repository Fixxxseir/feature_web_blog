class Article:
    ...
    @classmethod
    def insert(cls, title: str, content: str) -> object:
...
if __name__ == "__main__":
    ...
    new_article_3 = Article.insert('test2', 'test2')
    print(new_article_3.article_id)

    new_article_4 = Article.insert('test2', 'test2')
    print(new_article_4.article_id)
